...
void Bureaucrat::signForm(Form &form)
{
    try
    {
        ...
        std::cout << "+--------------------------------+" << std::endl;
        std::cout << "| Name:   " << std::setw(22) << this->name << " |" << std::endl;
        std::cout << "| Grade:  " << std::setw(22) << this->grade << " |" << std::endl;
        std::cout << "+--------------------------------+" << std::endl;
    }
...
{
    os << "+--------------------------------+" << std::endl;
    os << "| Name:   " << std::setw(22) << bur.getName() << " |" << std::endl;
    os << "| Grade:  " << std::setw(22) << bur.getGrade() << " |" << std::endl;
    os << "+--------------------------------+" << std::endl;
    return os;
}